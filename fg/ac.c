...
ASN1_SEQUENCE(AC_FORM) = {
  ...
  ASN1_EXP_OPT(AC_FORM, is, AC_IS, 0),
  ASN1_EXP_OPT(AC_FORM, digest, AC_DIGEST, 1)
...
ASN1_SEQUENCE(AC_HOLDER) = {
  ASN1_EXP_OPT(AC_HOLDER, baseid, AC_IS, 0),
  ASN1_EXP_OPT(AC_HOLDER, name, GENERAL_NAMES, 1),
  ASN1_EXP_OPT(AC_HOLDER, digest, AC_DIGEST, 2)
...
ASN1_SEQUENCE(AC_INFO) = {
  ...
  ASN1_EXP(AC_INFO, form, AC_FORM, 0), /* shortcut a CHOICE with a mandatory
                                          field */
