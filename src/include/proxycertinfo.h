...
#define PROXYCERTINFO_V3                PROXYCERTINFO_OLD_OID
#define PROXYCERTINFO_OID               "1.3.6.1.5.5.7.1.14"
#define PROXYCERTINFO_V4                PROXYCERTINFO_OID
...
#define PROXYCERTINFO_set_proxypolicy(pci, policy) PROXYCERTINFO_set_policy(pci, policy)
