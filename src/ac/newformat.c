...
ASN1_SEQUENCE(AC_IS) = {
  ASN1_SEQUENCE_OF(AC_IS, issuer, GENERAL_NAME),
  ASN1_SIMPLE(AC_IS, serial, ASN1_INTEGER),
  ASN1_SIMPLE(AC_IS, uid, ASN1_BIT_STRING)
} ASN1_SEQUENCE_END(AC_IS)

IMPLEMENT_ASN1_FUNCTIONS(AC_IS)

ASN1_SEQUENCE(AC_FORM) = {
  ASN1_SEQUENCE_OF(AC_FORM, names, GENERAL_NAME),
  ASN1_SIMPLE(AC_FORM, is, AC_IS),
  ASN1_SIMPLE(AC_FORM, digest, AC_DIGEST)
...
ASN1_SEQUENCE(AC_HOLDER) = {
  ASN1_SIMPLE(AC_HOLDER, baseid, AC_IS),
  ASN1_SEQUENCE_OF(AC_HOLDER, name, GENERAL_NAMES),
  ASN1_SIMPLE(AC_HOLDER, digest, AC_DIGEST)
...
ASN1_SEQUENCE(AC_IETFATTR) = {
  ASN1_SEQUENCE_OF(AC_IETFATTR, names, GENERAL_NAME),
...
ASN1_SEQUENCE(AC_ATTR) = {
  ...
  ASN1_SEQUENCE_OF(AC_ATTR, ietfattr, AC_IETFATTR),
  ASN1_SEQUENCE_OF(AC_ATTR, fullattributes, AC_FULL_ATTRIBUTES)
...
ASN1_SEQUENCE(AC_INFO) = {
  ...
  ASN1_SIMPLE(AC_INFO, form, AC_FORM),
